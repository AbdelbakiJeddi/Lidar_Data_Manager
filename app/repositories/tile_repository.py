...
class TileRepository:
    ...
    async def get_by_grid_index(
        self, dataset_id: str, grid_x: int, grid_y: int
    ) -> Optional[Dict[str, Any]]:
        """Get a single tile by dataset and grid index."""
        return await self.collection.find_one(
            {"dataset_id": dataset_id, "grid_x": grid_x, "grid_y": grid_y}, {"_id": 0}
        )
